...
def get_args(rest_args):
    ...
    parser.add_argument('--online-rollouts-per-task', default=2)
    ...
    parser.add_argument('--num-online-steps', type=int, default=500000, help="number fine-tuning steps")
    ...
    parser.add_argument('--onlinereplaysize', type=int, default=50000,
                        help="replay buffer size used for online finetuning")
    
    parser.add_argument("--test-use-online", default=False)
    ...
    parser.add_argument('--state-feat-dim', type=int, default=32)
