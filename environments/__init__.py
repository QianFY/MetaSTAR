...
register(
    'HopperRandParamsSparse-v0',
    entry_point='environments.wrappers:mujoco_wrapper',
    kwargs={'entry_point': 'environments.mujoco.rand_param_envs.hopper_rand_params_sparse:HopperRandParamsSparseEnv',
            }
)
...
register(
    'WalkerRandParamsSparse-v0',
    entry_point='environments.wrappers:mujoco_wrapper',
    kwargs={'entry_point': 'environments.mujoco.rand_param_envs.walker2d_rand_params_sparse:Walker2DRandParamsSparseEnv',
            }
)