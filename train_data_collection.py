...
from data_collection_config import args_cheetah_vel, args_cheetah_dir, args_ant_dir, args_ant_semicircle, \
    args_point_robot_sparse, args_cheetah_vel_sparse, args_hopper_param, args_walker_param, args_reach, \
    args_push, args_walker_param_sparse, args_hopper_param_sparse
...
def main():
    ...
    # parser.add_argument('--env-type', default='push')
    ...
    # --- MetaWorld ---
        ...
        args = args_push.get_args(rest_args)
    else:
        raise NotImplementedError

    set_gpu_mode(torch.cuda.is_available(), gpu_id=0)
